...
describe('BankAccount e2e test', () => {
  ...
  const bankAccountSample = { name: 'however lest', balance: 21049.8 };
  ...
  describe('new BankAccount page', () => {
    ...
    it('should create an instance of BankAccount', () => {
      cy.get(`[data-cy="name"]`).type('colorless amongst which');
      cy.get(`[data-cy="name"]`).should('have.value', 'colorless amongst which');

      cy.get(`[data-cy="balance"]`).type('23973.44');
      cy.get(`[data-cy="balance"]`).should('have.value', '23973.44');

(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('jhipsterSampleGatewayApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-jhipsterSampleGatewayApp-error');
                var entityKey = httpResponse.headers('X-jhipsterSampleGatewayApp-params');
                if (errorHeader) {

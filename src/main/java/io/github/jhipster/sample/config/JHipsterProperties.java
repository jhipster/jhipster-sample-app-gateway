...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "jhipsterSampleGateway@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "jhipsterSampleGateway API";

        private String description = "jhipsterSampleGateway API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "jhipsterSampleGateway";
